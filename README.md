...
<p align="center">
  <img src="src/title.png" alt="토르 키우기 타이틀 화면" width="32%">
  <img src="src/battle.png" alt="토르 키우기 전투 화면" width="32%">
  <img src="src/item.png" alt="토르 키우기 아이템 화면" width="32%">
</p>

‘토르 키우기’는 ‘Vampire Survivors’ 와 같은 서바이벌 장르의 게임에 방치형 RPG의 지속적인 성장과 파밍 구조를 결합한 방치형 서바이벌 RPG 게임입니다. 게임 전반을 기획하고 클라이언트 대부분 및 서버를 개발했으며, 출시 전 개발을 중단했습니다.
